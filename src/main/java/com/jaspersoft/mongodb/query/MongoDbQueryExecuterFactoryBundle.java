 ...
 * 
 */
public class MongoDbQueryExecuterFactoryBundle implements QueryExecuterFactoryBundle {
  ...
  public JRQueryExecuterFactory getQueryExecuterFactory(String language) throws JRException {
    if (MongoDbDataSource.QUERY_LANGUAGE.equals(language)) {
      return (JRQueryExecuterFactory) cache.getCachedInstance(MongoDbQueryExecuterFactory.class.getName());
    }
    return null;
  }
}